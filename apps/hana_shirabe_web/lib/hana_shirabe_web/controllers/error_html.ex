defmodule HanaShirabeWeb.ErrorHTML do
  @moduledoc """
  ...
  # 中添加对应的页面：
  #
  #   * lib/hana_shirabe_web/controllers/error_html/404.html.heex
  #   * lib/hana_shirabe_web/controllers/error_html/500.html.heex
  #
