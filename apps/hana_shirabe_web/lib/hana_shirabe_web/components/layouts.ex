defmodule HanaShirabeWeb.Layouts do
  ...
  def theme_toggle(assigns) do
    ...
    <div class="card relative flex flex-row items-center border-2 border-base-300 bg-base-300 rounded-full">
      <div class="absolute w-1/3 h-full rounded-full border-1 border-base-200 bg-base-100 brightness-200 left-0 [[data-theme=corn-cream-soup]_&]:left-1/3 [[data-theme=noctilucent]_&]:left-2/3 transition-[left]" />
      <button
      ...
      <button
        class="flex p-2 cursor-pointer w-1/3"
        phx-click={JS.dispatch("phx:set-theme")}
        data-phx-theme="corn-cream-soup"
      >
