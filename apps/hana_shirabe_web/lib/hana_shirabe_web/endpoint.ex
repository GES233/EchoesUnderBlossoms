defmodule HanaShirabeWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :hana_shirabe_web

  # Session 将在 cookie 中保存并被签名，这意味着它的内容可以被阅读
  # 却无法被篡改。 如果你想要加密的话可以设置 :encryption_salt 。
  @session_options [
    store: :cookie,
    key: "_hana_shirabe_web_key",
    signing_salt: "7ATKeWmf",
    same_site: "Lax"
  ]
  ...
  plug Plug.Static,
    at: "/",
    from: :hana_shirabe_web,
    gzip: not code_reloading?,
    only: HanaShirabeWeb.static_paths()
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :hana_shirabe_web
  end
